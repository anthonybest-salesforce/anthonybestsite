...
window.GUIDE_ERAS = [
      ...
      videos: [
        {
          ...
          note: `Full rig walkthrough. Describes the Friedman-modded 1978 Marshall Super Lead reworked with a Naylor-style preamp — the same amp lineage as the Naked — though the video's own companion article doesn't use the "Naked" brand name. Per the site owner's direct viewing of the on-camera footage (not corroborated by the written article, which describes only one head-format amp): Howerdel's touring rig shown here includes two rack-mounted Naked units, the original modded Marshall head itself, and a two-input Marshall 2203 "Lead MkII" — all part of the same live setup. This detail is owner-sourced from the video itself — flagged with a timestamp-TBD citation until independently re-confirmed.`,
        },
        {
          title: `Riff Rundown — "Judith"`,
          url: `https://www.youtube.com/watch?v=AmxgaC9bp1E`,
          source: `Premier Guitar, Dec 23 2018`,
          note: `Riff/tutorial format; no dedicated amp discussion. Per the site owner: the head shown on camera here may be a different unit than the one identified in the Rig Rundown video above — not confirmed, flagged for a closer side-by-side comparison.`,
        },
        {
  ...
  },
  {
    ...
    body: [
      ...
      `A limited reissue surfaced around 2010 through the retailer Tone Merchants, and original-run units still turn up on the resale market today — genuinely rare, and genuinely chased by anyone hunting that specific Marshall-meets-Naylor snarl.`,
    ],
    quote: {
  ...
  },
  {
    ...
    body: [
      `This one's personal: the site owner tracked down and owned one of these amps himself. It's a second run of the Mk1 circuit, distinct in construction from the original Metro-kit clones, finished entirely in black. Instead of starting from a modified Marshall chassis, Friedman built these from scratch on his own chassis and parts — by hand, himself.`,
